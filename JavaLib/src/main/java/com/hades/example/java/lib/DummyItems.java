...
public class DummyItems {
    ...
    public static final List<DummyItem> ITEMS_4_2 = new ArrayList<>();
    ...
    public static List<DummyItem> ITEMS_4_2() {
        if (!ITEMS_4_2.isEmpty()) {
            ITEMS_4_2.clear();
        }

        ITEMS_4_2.addAll(createList_4_v2());
        return ITEMS_4_2;
    }
    ...
    private static List<DummyItem> createList_4_v2() {
        List<DummyItem> list = new ArrayList<>();
        list.add(new DummyItem(1, "City", 1));
        list.add(new DummyItem(2, "China", 11));
        list.add(new DummyItem(2, "China2", 10));
        list.add(new DummyItem(3, "D", 2));
        return list;
    }
