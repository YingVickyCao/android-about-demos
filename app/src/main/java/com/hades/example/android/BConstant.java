...
public class BConstant {
    ...
    public final static String B_REMOTEBOUNDEDSERVICE2_CLASS = "com.hades.example.android.b.bound_service.RemoteBoundedService2";
    public final static String B_REMOTEBOUNDEDSERVICE_CLASS_ACTION = B_REMOTEBOUNDEDSERVICE_CLASS;
    public final static String B_REMOTEBOUNDEDSERVICE2_CLASS_ACTION = B_REMOTEBOUNDEDSERVICE2_CLASS;
