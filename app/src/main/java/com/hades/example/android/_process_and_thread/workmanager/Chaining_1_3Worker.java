 ...
 */
public class Chaining_1_3Worker extends Worker {
    private static final String TAG = Chaining_1_3Worker.class.getSimpleName();

    public Chaining_1_3Worker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
...
//        int result = sum + num;
        ...
        Data outputData = new Data.Builder()
                .putString(WorkManagerFragment.KEY_PLANT_NAME_3, "X")
                .build();
