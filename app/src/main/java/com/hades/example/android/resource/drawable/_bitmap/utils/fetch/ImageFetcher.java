package com.hades.example.android.resource.drawable._bitmap.utils.fetch;
...
import com.hades.example.android.resource.drawable._bitmap.utils.cache.disk.DiskLruCache;
...
public class ImageFetcher extends ImageResize {
    ...
    private Bitmap processBitmap4DownloadResize(String data) {
        ...
        if (fileDescriptor != null) {
            bitmap = imageUtil.decodeFileDescriptor(fileDescriptor, mImageWidth, mImageHeight, mImageCache);
        }
