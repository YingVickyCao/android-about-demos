...
public class TestSurfaceViewPlayVideo2Fragment extends Fragment implements SurfaceHolder.Callback, MediaPlayer.OnPreparedListener, IMediaPlayer, ITimerView {
    private static final String TAG = TestSurfaceViewPlayVideo2Fragment.class.getSimpleName();
