...
public class DownloadTracker {
    ...
    public void toggleDownload(FragmentManager fragmentManager, String name, Uri uri, String extension, RenderersFactory renderersFactory) {
        Download download = downloads.get(uri);
        if (download != null) {
            DownloadService.sendRemoveDownload(context, DownloadService.class, download.request.id, /* foreground= */ false);
        } else {
    ...
    private final class StartDownloadDialogHelper implements DownloadHelper.Callback, DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
        ...
        public void onPrepared(DownloadHelper helper) {
            ...
            trackSelectionDialog = TrackSelectionDialog.createForMappedTrackInfoAndParameters(R.string.exo_download_description, mappedTrackInfo, trackSelectorParameters, false,
                    true, this, this);
        ...
        public void onPrepareError(DownloadHelper helper, IOException e) {
            ...
            Log.e(TAG, e instanceof DownloadHelper.LiveContentUnsupportedException ? "Downloading live content unsupported" : "Failed to start download", e);
        }
            ...
            for (int periodIndex = 0; periodIndex < downloadHelper.getPeriodCount(); periodIndex++) {
                ...
                for (int i = 0; i < mappedTrackInfo.getRendererCount(); i++) {
                    if (!trackSelectionDialog.getIsDisabled(i)) {
                        downloadHelper.addTrackSelectionForSingleRenderer(periodIndex,                                /* rendererIndex= */ i, trackSelectorParameters, trackSelectionDialog.getOverrides(/* rendererIndex= */ i));
                    }
                }
            }
        ...
        private void startDownload(DownloadRequest downloadRequest) {
            DownloadService.sendAddDownload(context, DownloadService.class, downloadRequest, /* foreground= */ false);
        }
