 ...
 * FontMetric
 */
public class Text4FontMetric extends View {
    private static final String TAG = Text4FontMetric.class.getSimpleName();

    private Paint paint;

    public Text4FontMetric(Context context, AttributeSet set) {
        super(context, set);
        paint = new Paint();
...
//        int text_height_half_Y = fontMetrics.top + (fontMetrics.bottom - fontMetrics.top) / 2;
        int y_of_half_text_height = top_y + (fontMetrics.bottom - fontMetrics.top) / 2;
