...
public class PlayerActivity extends AppCompatActivity implements OnClickListener, PlaybackPreparer, PlayerControlView.VisibilityListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lib_exoplayer_player_activity);
    ...
    private void initializePlayer() {
        if (mPlayer == null) {
            ...
            RenderersFactory renderersFactory = ((App) getApplication()).buildRenderersFactory(preferExtensionDecoders);

            trackSelector = new DefaultTrackSelector(this, trackSelectionFactory);
            trackSelector.setParameters(trackSelectorParameters);
            lastSeenTrackGroupArray = null;

            mPlayer = new SimpleExoPlayer.Builder(this, renderersFactory)
    ...
    private MediaSource createTopLevelMediaSource(Intent intent) {
        ...
        UriSample[] samples = intentAsSample instanceof PlaylistSample ? ((PlaylistSample) intentAsSample).children : new UriSample[]{(UriSample) intentAsSample};
        ...
        for (int i = 0; i < samples.length; i++) {
            ...
            SubtitleInfo subtitleInfo = samples[i].subtitleInfo;
    ...
    private MediaSource createLeafMediaSource(UriSample parameters) {
        DrmInfo drmInfo = parameters.drmInfo;
